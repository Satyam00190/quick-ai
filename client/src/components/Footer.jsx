                ...
                <div className="md:max-w-96">
                    <img className="h-9" src={assets.logo} alt="dummyLogoDark"/>
                        <p className="mt-6 text-sm">
                           Experience the power of AI with QuickAi <br/>Transform your content creation with our suite of primium AI tools.Write articles,generate images,and enhnace your workflow
                        </p>
                </div>
